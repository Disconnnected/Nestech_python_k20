...
def solve(colors):
    ...
    result = None
    html = [
        f'<span style="color:{colors["xanh da trời"]}">G</span>',
        f'<span style="color:{colors["đỏ"]}">o</span>',
        f'<span style="color:{colors["vàng"]}">o</span>',
        f'<span style="color:{colors["xanh da trời"]}">g</span>',
        f'<span style="color:{colors["xanh lá"]}">l</span>',
        f'<span style="color:{colors["đỏ"]}">e</span>',
        
    ]
    result = list(zip("Google",html))
    return result
